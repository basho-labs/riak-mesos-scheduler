...
init([]) ->
    ...
    EVENTS = {riak_mesos_event_coordinator,
              {riak_mesos_event_coordinator, start_link, [[]]},
              permanent, 5000, worker, [riak_mesos_event_coordinator]},
    CLUSTERS = {riak_mesos_cluster_manager,
                {riak_mesos_cluster_manager, start_link, [[]]},
                permanent, 5000, worker, [riak_mesos_cluster_manager]},
    ...
    Processes = [EVENTS, CLUSTERS, WEB, SCHEDULER],
